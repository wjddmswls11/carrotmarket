...
public class AroundDTO3 {
    private int around_coupon, around_coupon_perimgper;
    ...
    public AroundDTO3(int around_coupon, int around_coupon_perimgper, String around_coupon_shopname, String around_coupon_distance, String arouond_coupon_info, String around_coupon_person, String coupon_guest, String coupon_review) {
