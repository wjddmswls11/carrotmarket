...
import static com.example.carrotmarket.around.AroundCouponActivity.couponget;
...
public class AroundAdapter3 extends RecyclerView.Adapter<AroundAdapter3.RecHolder>{
    ...
    public void onBindViewHolder(@NonNull RecHolder h, @SuppressLint("RecyclerView") int i) {
        ...
        h.popup_coupon.setImageResource(list3.get(i).getPopup_coupon());
    ...
    public class RecHolder extends RecyclerView.ViewHolder {
        ImageView around_coupon, around_coupon_perimgper, popup_coupon;
